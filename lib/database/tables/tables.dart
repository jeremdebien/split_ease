...
// Join table: many-to-many relation between Persons and PersonGroups
class PersonGroupMembers extends Table {
  IntColumn get personGroupId => integer().customConstraint('NOT NULL REFERENCES person_groups(id) ON DELETE CASCADE')();
  IntColumn get personId => integer().customConstraint('NOT NULL REFERENCES persons(id) ON DELETE CASCADE')();

  @override
  Set<Column> get primaryKey => {personGroupId, personId};
}
